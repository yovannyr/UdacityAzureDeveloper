...
class Config(object):
    ...
    SQL_SERVER = os.environ.get('SQL_SERVER') or 'yrod-article-cms.database.windows.net'
    SQL_DATABASE = os.environ.get('SQL_DATABASE') or 'article_cms_blogs'
    SQL_USER_NAME = os.environ.get('SQL_USER_NAME') or 'yrodriguz'
    ...
    CLIENT_SECRET = "LC0NC_Nv_ncfo6sJUA3f0HR2D_TyAT5F_s"
    ...
    CLIENT_ID = "99953a5e-ca79-48fe-b02b-1d9a9595ec81"
